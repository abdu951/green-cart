  ...
  return (
    <div className='relative'>
        ...
        md:pb-0 px-4 md:pl-18 lg:pl-24'>
            ...
            lg:max-w-105 leading-tight md:leading-15'>freashness you can trust, saving you will love!</h1>
        
        <div className='flex items-center mt-6 font-medium'>
            <Link to={"/products"} className='group flex items-center gap-2 px-7 md:px-9 py-3 bg-primary
             hover:bg-primary-dull transition rounded cursor-pointer text-white'>shop now
